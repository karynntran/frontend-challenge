	...
	return (
		<section id="Info">
			<div className="Info-content">
				...
				<p className="Info-question"><span className="copy-orange">[ Q. ]</span> Why did the child component have such great self-esteem?</p>
				<p className="Info-answer"><span className="copy-orange">[ A. ]</span> Because its parent kept giving it props!</p>
